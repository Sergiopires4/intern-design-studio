...
const about = {
  headline: "Engineered for {{clarity}}",
  // wrap one word in {{ }} to highlight
  paragraphs: [
...
const projects = [
  {
    id: "Flip Cards UI",
    date: "03/22",
    blurb: "An interactive card UI with flip animations, showcasing front-end skills in animations and responsive design.",
  ...
  },
  {
    ...
    date: "04/19",
    blurb: "A visually engaging website using parallax scrolling effects to create depth and smooth user experience.",
    stack: ["HTML", "CSS", "JavaScript"],
    role: "Solo build",
...
const timeline = [
  {
    ...
    detail: "GPA: 3.7 / 4.0. Focused on web development and software engineering.",
    badge: "ACTIVE"
  },
  {
    period: "Ongoing",
    ...
    detail: "Currently seeking internship opportunities in web development.",
    badge: "AVAILABLE"
  },
  {
    period: "Pre-2022",
    ...
    org: "Previous School",
    detail: "Completed pre-university education with focus on science and mathematics.",
    badge: "FOUNDATION"
  }
];
const courses = [
...
const Route$4 = createFileRoute("/skills")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: `Skills — ${identity.fullName}`
    }, {
...
const Route$3 = createFileRoute("/projects")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: `Projects — ${identity.fullName}`
    }, {
      property: "og:description",
      content: `Selected coding projects by ${identity.fullName}.`
    }]
...
const Route$2 = createFileRoute("/favourites")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: `Favourites — ${identity.fullName}`
    }, {
      property: "og:description",
...
const Route$1 = createFileRoute("/academics")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: `Academics — ${identity.fullName}`
    }, {
      property: "og:description",
...
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: `${identity.fullName} — Portfolio`
    }, {
      property: "og:description",
      content: identity.bio
    }]
...
const SkillsRoute = Route$4.update({
  id: "/skills",
  path: "/skills",
...
const FavouritesRoute = Route$2.update({
  id: "/favourites",
  path: "/favourites",
  getParentRoute: () => Route$5
});
const AcademicsRoute = Route$1.update({
  id: "/academics",
  path: "/academics",
  getParentRoute: () => Route$5
});
